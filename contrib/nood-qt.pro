...
RESOURCES += src/qt/nood.qrc src/qt/nood_locale.qrc

TRANSLATIONS += src/qt/locale/nood_bg.ts \
                src/qt/locale/nood_de.ts \
                src/qt/locale/nood_en.ts \
                src/qt/locale/nood_es.ts \
                src/qt/locale/nood_fi.ts \
                src/qt/locale/nood_fr.ts \
                src/qt/locale/nood_it.ts \
                src/qt/locale/nood_ja.ts \
                src/qt/locale/nood_pl.ts \
                src/qt/locale/nood_pt.ts \
                src/qt/locale/nood_ru.ts \
                src/qt/locale/nood_sk.ts \
                src/qt/locale/nood_sv.ts \
                src/qt/locale/nood_vi.ts \
                src/qt/locale/nood_zh_CN.ts \
                src/qt/locale/nood_zh_TW.ts