...
In order to support loading of multiple wallets in nood-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nood.cpp.
...
nood.cpp is the entry point into nood-qt, and as such, will require some minor modifications to provide hooks for
