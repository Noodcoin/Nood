...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* nood features */
        {"nood", "masternode", &masternode, true, true, false},
        {"nood", "masternodelist", &masternodelist, true, true, false},
        {"nood", "mnbudget", &mnbudget, true, true, false},
        {"nood", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"nood", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nood", "mnsync", &mnsync, true, true, false},
        {"nood", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"nood", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use noodd, or the -server option to nood-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nood-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51556/\n";
}
