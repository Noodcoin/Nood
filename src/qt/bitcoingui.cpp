...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a nood address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nood:URIs)"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About nood Core"), this);
    aboutAction->setStatusTip(tr("Show information about nood Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for nood"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your nood addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify_menu"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified nood addresses"));
    ...
    openAction->setStatusTip(tr("Open a nood:URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the nood Core help message to get a list with possible nood command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("nood Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to nood network", "", count));
}
...
{
    QString strTitle = tr("nood"); // default title
