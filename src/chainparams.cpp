...
static Checkpoints::MapCheckpoints mapCheckpoints =
        boost::assign::map_list_of 
		 (0, uint256("0x00000c05bde561599805af9c8645d7fad435f18577049ca78cece8a56c6f8f7e"))
	        (20, uint256("0x00000ea5cd635e899ba06b1f5f658c80368a2831ad7ad0cd450f4afd3f883030"))
	        (30, uint256("0x0000027b522f5b8e33716f273be1db9e94ab9936f632dfbc35ccef5ef57cd3a6"))
		(9700, uint256("0x000000000733dffd72a7bbf5496030ab1c486b189943ea9acb308c1af3feb7b6"));



static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1557273111, // * UNIX timestamp of last checkpoint block
    10637,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 4 * 60; // nood: 4 minutes
        nTargetSpacing = 2 * 60;  // nood: 2 minute
        nLastPOWBlock = 1274030;
        nMaturity = 15;
	...
	nMasternodeColleteralLimxDev = 1000; //Params().MasternodeColleteralLimxDev()
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1555894932;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 32519374;
		
		
		
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000c05bde561599805af9c8645d7fad435f18577049ca78cece8a56c6f8f7e"));
        assert(genesis.hashMerkleRoot == uint256("0x38ac89566581e16f64b6f20f9b190286e11682e636c722247ed87f9482444b4e"));
	...
	vSeeds.push_back(CDNSSeedData("34.74.85.190", "34.74.85.190"));  
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x1E)(0xAD)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x04)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        // Testnet nood BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nood BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet nood BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 5 * 60; // nood: 5 minutes
        nTargetSpacing = 1 * 60;  // nood: 1 minute
